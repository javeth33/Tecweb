...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	// NOTA: Se ha eliminado la verificación del parámetro 'tope' y la lógica de unidades.
	// Ahora solo se conecta y se consulta por productos vigentes (eliminado = 0).
	
	// Configuración de conexión (Asegúrate de que 'root' y la contraseña sean correctas)
	@$link = new mysqli('localhost', 'root', '', 'marketzone'); // Usé '' como contraseña, ajústala si es '12345'
	...
	if ( $result = $link->query($sql) )
	{
		...
		// Manejo de codificación de detalles (utf8_encode se mantiene para compatibilidad con el código original)
