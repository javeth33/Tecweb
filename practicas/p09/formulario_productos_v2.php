...
<script>
    ...
    function validarFormulario() {
        ...
        if (modelo === '' || modelo.length > 25 || !alphanumericRegex.test(modelo)) {
            document.getElementById('error-modelo').style.display = 'block';
            isValid = false;
        }
        ...
        if (isNaN(unidades) || unidades < 0) {
             document.getElementById('error-unidades').style.display = 'block';
            isValid = false;
        }
